...
/* Global constants */
const int INITIALIZER_PRODUCTSTATS = 2;
const float MONEY_TOL = 0.01;
/* Data structures */
typedef struct { /* Contains information about a single price point,
    defined by the price point and unit cost */
    unsigned m_noUnits; /* No. of units sold at this price point */
    float m_price; /* Selling price for this price point */
    float m_cost; /* Variable cost at this price point */
    float m_unitDist; /* Proportion of units sold at this price point */
    float m_revDist; /* Proportion of revenue at this price point */
    float m_profitDist; /* Proportion of profit at this price point */
} pricePoint; 
/* ------------------------------------------------------------------------- */
